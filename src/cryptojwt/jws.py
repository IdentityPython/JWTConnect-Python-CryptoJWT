...
from cryptojwt import b64d_enc_dec
from cryptojwt import b64e
from cryptojwt import b64e_enc_dec
from cryptojwt import b64encode_item
from cryptojwt import constant_time_compare
...
from cryptojwt.jwk import sha512_digest
...
class RSASigner(Signer):
    ...
    def sign(self, msg, key):
        sig = key.sign(msg, padding.PKCS1v15(), self.hash_algorithm())
        return sig

    def verify(self, msg, signature, key):
        try:
            key.verify(signature, msg, padding.PKCS1v15(),
                       self.hash_algorithm())
...
SIGNER_ALGS = {
    ...
    'ES256': DSASigner('SHA256'),
    'ES384': DSASigner('SHA384'),
    'ES512': DSASigner('SHA512'),
